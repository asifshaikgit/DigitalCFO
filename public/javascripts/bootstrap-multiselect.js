...
!function ($) {
	...
	function Multiselect(select, options) {
		...
		this.$container = $(this.options.buttonContainer)
	        ...
	        .append('<div class="multiselect-container dropdown-menu" style="position:;"><ul style="list-style-type: none;margin:0;padding:0;"></ul></div>');
		...
		if (this.options.enableFiltering) {
		    if(this.$select.attr('class')=="multipleVendorSeller"){
				$('.multiselect-container', this.$container).prepend('<div class="input-prepend" style="padding:3px;"><input style="width:200px;" id="multipleVendorSellerInput" class="multiselect-search search-image" type="text" placeholder="' + this.options.filterPlaceholder + '"><img style="padding-right:30px;margin-top:1px;" class="vendSupplierAddToContainer" src="assets/images/plus.png" onclick="addLocationToContainer(this)"></div>');
			}else{
				$('.multiselect-container', this.$container).prepend('<div class="input-prepend" style="padding:3px;"><input style="width:200px;" class="multiselect-search search-image" type="text" placeholder="' + this.options.filterPlaceholder + '"></div>');
			}
